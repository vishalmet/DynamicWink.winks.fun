    ...
    <div className="bg-[#2a2a2a] min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#333] p-8 rounded-lg">
          <h2 className="text-[#2647ff] text-2xl font-bold mb-4 text-center">Ready to Create?</h2>
          ...
          <div className="space-y-4">
            <div className="flex flex-col space-y-2">
              ...
              <input
                ...
                className="bg-[#444] text-[#f8f8f8] px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-[#2647ff]"
            ...
            <button
              ...
              className="w-full bg-[#2647ff] text-[#f8f8f8] px-8 py-4 rounded-lg hover:scale-105 transition-transform duration-300"
            >
              Generate Link
            </button>
            ...
            {generatedLink && (
              <div className="mt-4 p-4 bg-[#444] rounded-lg">
                ...
                <p className="text-[#2647ff] break-all">{generatedLink}</p>
              </div>
            )}
          </div>
        </div>
